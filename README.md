...
This repository is an official Pytorch implementation of the paper [**"Clustering-Guided Class Activation for Weakly Supervised Semantic Segmentation"**](https://ieeexplore.ieee.org/document/10381698)) <br>
